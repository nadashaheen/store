...
(25, 'CASUAL SUIT', 'casual suit Available in several colors, comfortable to wear It can be worn on many occasions It can be ordered now from our store in the right size and color ..\r\n\r\n', 500, 'brown', 'L', 'Yes', 'Yes', 5, '../images/clothes/14.jpg'),
(26, 'BABY SUIT GIRL', 'baby suit girl Available in several colors, comfortable to wear It can be worn on many occasions It can be ordered now from our store in the right size and color ..\r\n\r\n', 600, 'yellow', 'M', 'Yes', 'Yes', 6, '../images/clothes/15.jpg'),
(27, 'FULL OUTFIT', 'Full outfit Available in several colors, comfortable to wear It can be worn on many occasions It can be ordered now from our store in the right size and color ..\r\n\r\n', 500, 'WHITE&LIGHT GREEN', 'L', 'Yes', 'Yes', 7, '../images/clothes/16.jpg');
